...
export const EXAMPLE_EVENTS = [
  {
    ...
    description:
      "Technical interview for the backend developer position with Acme Corp.",
  ...
  },
  {
    ...
    description:
      "Learn how to craft an effective resume that stands out to recruiters.",
  ...
  },
  {
    ...
    description:
      "Annual career fair with over 50 companies from tech, finance, and healthcare sectors.",
  ...
  },
  {
    ...
    description:
      "Guest speaker from MedTech discussing applications of AI in modern healthcare.",
  ...
  },
  {
    ...
    description:
      "Technical interview for the frontend developer position with TechStart Inc.",
    type: EVENT_TYPES.INTERVIEW,
    start: new Date(
      new Date().getFullYear(),
      new Date().getMonth(),
  ...
  },
  {
    ...
    description:
      "Learn effective networking techniques for career development.",
    type: EVENT_TYPES.WORKSHOP,
    start: new Date(
      new Date().getFullYear(),
      new Date().getMonth(),
  ...
  },
  {
    ...
    description:
      "Information session about data science career paths and opportunities.",
    type: EVENT_TYPES.CAMPUS_EVENT,
    start: new Date(
      new Date().getFullYear(),
      new Date().getMonth(),
  ...
  },
  {
    ...
    description:
      "Interview for the associate product manager position with GrowthCo.",
    type: EVENT_TYPES.INTERVIEW,
    start: new Date(
      new Date().getFullYear(),
      new Date().getMonth(),
  ...
  },
  {
    ...
    description:
      "Learn how to maximize your LinkedIn profile for job searching and networking.",
    type: EVENT_TYPES.WORKSHOP,
    start: new Date(
      new Date().getFullYear(),
      new Date().getMonth(),
